# How Do CPUs Support AI Workloads?

AI systems need processing power to turn data into predictions, generated text, images, and decisions. The **CPU** is the general-purpose processor that runs application logic and coordinates AI workloads.
